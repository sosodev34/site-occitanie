...
export function BoxesSection({ onAddToCart }: BoxesSectionProps) {
  ...
  const categoryMeta: Record<Box["category"], { label: string; icon: string }> = {
    decouverte: { label: t("boxes.filters.decouverte"), icon: "✨" },
    charcuterie: { label: t("boxes.filters.charcuterie"), icon: "🥘" },
  };
  ...
  const categories: Array<{ id: CategoryId; label: string; icon: string }> = [
    { id: "tous", label: t("boxes.filters.all"), icon: "🎁" },
  ...
  return (
    <section className="py-16 sm:py-20 scroll-mt-24" id="boxes" ref={rootRef}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-wrap justify-center gap-3 mb-12">
            {categories.map((category) => (
              <Button
                ...
                variant={effectiveSelectedCategory === category.id ? "default" : "outline"}
                className={[
              ...
              >
                ...
                <span data-i18n={`boxes.filters.${category.id === "tous" ? "all" : category.id}`}>
                  {category.label}
                </span>
              </Button>
            ))}
        ...
        <p className="mt-6 text-center text-xs text-muted-foreground" data-i18n="boxes.disclaimer">
          {t("boxes.disclaimer")}
        </p>
          ...
          <div className="max-w-3xl mx-auto text-center space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mt-8">
              <div data-gsap="how-step" className="space-y-2">
                ...
                <h4 className="text-foreground font-semibold" data-i18n="boxes.how.step1Title">
                  {t("boxes.how.step1Title")}
                </h4>
                <p className="text-sm text-muted-foreground" data-i18n="boxes.how.step1Desc">
                  {t("boxes.how.step1Desc")}
                </p>
              </div>
              <div data-gsap="how-step" className="space-y-2">
                <div className="w-12 h-12 bg-primary rounded-full flex items-center justify-center text-primary-foreground text-xl mx-auto">
                ...
                <h4 className="text-foreground font-semibold" data-i18n="boxes.how.step2Title">
                  {t("boxes.how.step2Title")}
                </h4>
                <p className="text-sm text-muted-foreground" data-i18n="boxes.how.step2Desc">
                  {t("boxes.how.step2Desc")}
                </p>
              </div>
              <div data-gsap="how-step" className="space-y-2">
                <div className="w-12 h-12 bg-primary rounded-full flex items-center justify-center text-primary-foreground text-xl mx-auto">
                ...
                <h4 className="text-foreground font-semibold" data-i18n="boxes.how.step3Title">
                  {t("boxes.how.step3Title")}
                </h4>
                <p className="text-sm text-muted-foreground" data-i18n="boxes.how.step3Desc">
                  {t("boxes.how.step3Desc")}
                </p>
              </div>
            </div>
          </div>
