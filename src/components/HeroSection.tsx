          ...
          <div className="space-y-6 sm:space-y-8">
            ...
            >
              ...
              >
                <span className="inline-flex items-center gap-2">
                  <span>Je précommande ma box</span>
            ...
            >
              <div className="surface border border-border rounded-2xl px-4 py-3">
                <div className="text-sm font-semibold text-foreground">Paiement en ligne</div>
                <div className="text-xs text-muted-foreground">Simple et sécurisé</div>
              </div>
              <div className="surface border border-border rounded-2xl px-4 py-3">
                <div className="text-sm font-semibold text-foreground">Retrait sur place</div>
                <div className="text-xs text-muted-foreground">Pendant l'événement</div>
              </div>
              <div className="surface border border-border rounded-2xl px-4 py-3">
                <div className="text-sm font-semibold text-foreground">100% local</div>
                <div className="text-xs text-muted-foreground">Producteurs du coin</div>
              </div>
            </div>
          </div>
          ...
          <div className="relative">
            ...
            >
              <div className="flex items-start gap-3">
                ...
                <div>
                  <div className="text-xs text-muted-foreground">Box signature</div>
                  <div className="font-serif text-foreground mt-1">Saveurs Occitanes</div>
                  <div className="text-primary mt-2 font-semibold">25€</div>
                </div>
              </div>
            </div>
          </div>
